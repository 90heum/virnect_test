                ...
                >
                  <div class="swiper-wrapper">
                    <div class="img-warpper swiper-slide">
                      <i
                        ><img
                          src="~/assets/images/slideLogo/koreaR&D.png"
                          alt="한국원자력연구원"
                      /></i>
                      <p class="contents">
                        버넥트 솔루션은 높은 신뢰성을 요구하는 분야에도 체계적인
                        정보관리와 최적의 안전관리 플랫폼을 제시합니다.
                      </p>
                      <p class="category">
                        - 한국원자력연구원, 폐기물총관리실 연구원 -
                      </p>
                    </div>
                    <div class="img-warpper swiper-slide">
                      <i
                        ><img
                          src="~/assets/images/slideLogo/doosanLogo.png"
                          alt="두산"
                      /></i>
                      <p class="contents">
                        버넥트 솔루션 도입은 발전산업 현장의 생산성 향상과
                        정보공유를 용이하게 지원합니다.
                      </p>
                      <p class="category">
                        - 두산중공업, 기술혁신연구원 에너지/환경기술개발팀 -
                      </p>
                    </div>
                    <div class="img-warpper swiper-slide">
                      <i
                        ><img
                          src="~/assets/images/slideLogo/hyundaiSteel.png"
                          alt="현대스틸"
                      /></i>
                      <p class="contents">
                        버넥트 솔루션은 저희 회사 Smart Factory 플랫폼 발전에
                        상당한 기여를 하였습니다.
                      </p>
                      <p class="category">- 현대제철 -</p>
                    </div>
                  </div>
