                ...
                >
                  <div class="swiper-wrapper">
                    <div class="img-warpper swiper-slide">
                      <i
                        ><img
                          src="~/assets/images/slideLogo/miraecityLogo.png"
                          alt="OCI"
                      /></i>
                      <p class="contents">
                        "교량 등 시설물 안전점검에 적용 후 현장과 오피스 간
                        실시간 교식으로 점검자의 효율이 올라가고 있습니다."
                      </p>
                      <p class="category">- 미래시티 -</p>
                    </div>
                    <div class="img-warpper swiper-slide">
                      <i
                        ><img
                          src="~/assets/images/slideLogo/SkC&CLogo.png"
                          alt="sk"
                      /></i>
                      <p class="contents">
                        현장 설비유지보수 업무에 AR솔루션 활용하니 업무
                        이해도<br />
                        빠르고, 작업효율성도 좋아져서 업무가 쉬워 졌습니다.
                      </p>
                      <p class="category">- SK CnC -</p>
                    </div>
                    <div class="img-warpper swiper-slide">
                      <i
                        ><img
                          src="~/assets/images/slideLogo/BimLogo.png"
                          alt="sk"
                      /></i>
                      <p class="contents">
                        증강현실 상에서 각종 구조물의 사전 Digital Mock Up을
                        구현, 활용으로 도면의 이해력과 숙련도 향상 및 업무
                        협의에 큰 도움이 되었습니다.
                      </p>
                      <p class="category">- 인프라 BIM -</p>
                    </div>
                    <div class="img-warpper swiper-slide">
                      <i
                        ><img
                          src="~/assets/images/slideLogo/Seollogo.png"
                          alt="seo"
                      /></i>
                      <p class="contents">
                        글로벌 AR 기업과 비교해도 손색없는 토종 AR 전문기업,
                        버넥트의 core 솔루션은 확실한 차별점을 가지고 있습니다.
                        산업생산성 향상에 필수적인 파트너가 될 것입니다.
                      </p>
                      <p class="category">- 서일이엔엠 -</p>
                    </div>
                  </div>
