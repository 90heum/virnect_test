                ...
                >
                  <div class="swiper-wrapper">
                    <div class="img-warpper swiper-slide">
                      <i
                        ><img
                          src="~/assets/images/slideLogo/samsungSDS.png"
                          alt="삼성SDS"
                      /></i>
                      <p class="contents">
                        "작업자 Inspection에 활용된 버넥트 XR 솔루션은
                        고객만족도를 크게 향상시켰습니다."
                      </p>
                      <p class="category">- 삼성SDS -</p>
                    </div>
                    <div class="img-warpper swiper-slide">
                      <i
                        ><img
                          src="~/assets/images/slideLogo/OCILogo.png"
                          alt="OCI"
                      /></i>
                      <p class="contents">
                        "설비 유지보수시 시간과 공간의 제약없이 빠르게 협업할 수
                        있는 강력한 Tool로 생각됩니다."
                      </p>
                      <p class="category">- OCI -</p>
                    </div>
                    <div class="img-warpper swiper-slide">
                      <i
                        ><img
                    ...
                    <div class="img-warpper swiper-slide">
                      <i
                        ><img
                          src="~/assets/images/slideLogo/lgChemical.png"
                          alt="두산"
                      /></i>
                      <p class="contents">
                        "해외 생산 사이트를 가지고 있는 입장에서 버넥트 리모트가
                        실제 업무 수행에 많은 도움이 되고 있습니다."
                      </p>
                      <p class="category">- LG화학 -</p>
                    </div>
                  </div>
